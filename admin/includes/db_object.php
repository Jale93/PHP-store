...
class Db_object {
    ...
    public static function find_by_query($sql) {
       ...
       public static function find_by_query_without_cls($sql,$instantation = false) {
		global $database;
		$result_set = $database->query($sql);
		$the_object_array = array();
                if(!$instantation){
    ...
    public static  function permalink($string)
        {
                $find = array('Ə','Ç', 'Ş', 'Ğ', 'Ü', 'İ', 'Ö', 'ə','ç', 'ş', 'ğ', 'ü', 'ö', 'ı', '+', '#');
                $replace = array('E','c', 's', 'g', 'u', 'i', 'o', 'e','c', 'sh', 'g', 'u', 'o', 'i', 'plus', 'sharp');
