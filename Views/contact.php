...
$param->person_name = $_POST['name'];
$param->person_email =$_POST['email'];
$param->phone_number =$_POST['telephone'];
$param->message =$_POST['message'];
$param->i_add_datetime = 'NOW()';
$param->is_visible = '1';
$param->response_datetime = 'NULL';
...
if($param->save()){
    ...
    echo '<script>var myAlert = new cAlert("Error was occured!", "success",10);myAlert.alert();</script>';
}
